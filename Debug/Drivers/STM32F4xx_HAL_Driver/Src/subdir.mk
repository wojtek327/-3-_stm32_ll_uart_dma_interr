...
Drivers/STM32F4xx_HAL_Driver/Src/%.o: ../Drivers/STM32F4xx_HAL_Driver/Src/%.c
	...
	@echo $(PWD)
	arm-none-eabi-gcc -mcpu=cortex-m4 -mthumb -mfloat-abi=hard -mfpu=fpv4-sp-d16 -DUSE_FULL_LL_DRIVER '-DHSE_VALUE=25000000' '-DHSE_STARTUP_TIMEOUT=100' '-DLSE_STARTUP_TIMEOUT=5000' '-DLSE_VALUE=32768' '-DEXTERNAL_CLOCK_VALUE=12288000' '-DHSI_VALUE=16000000' '-DLSI_VALUE=32000' '-DVDD_VALUE=3300' '-DPREFETCH_ENABLE=1' '-DINSTRUCTION_CACHE_ENABLE=1' '-DDATA_CACHE_ENABLE=1' '-D__weak=__attribute__((weak))' '-D__packed=__attribute__((__packed__))' -DSTM32F429xx -I"C:/Users/wojte/OneDrive/Pulpit/stm32f4_uart_LL_test/Inc" -I"C:/Users/wojte/OneDrive/Pulpit/stm32f4_uart_LL_test/Drivers/STM32F4xx_HAL_Driver/Inc" -I"C:/Users/wojte/OneDrive/Pulpit/stm32f4_uart_LL_test/Drivers/CMSIS/Device/ST/STM32F4xx/Include" -I"C:/Users/wojte/OneDrive/Pulpit/stm32f4_uart_LL_test/Drivers/CMSIS/Include"  -Og -g3 -Wall -fmessage-length=0 -ffunction-sections -c -fmessage-length=0 -MMD -MP -MF"$(@:%.o=%.d)" -MT"$@" -o "$@" "$<"
